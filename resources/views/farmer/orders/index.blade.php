                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">{{ $item->quantity }} × Rp {{ number_format($item->unit_price ?? 0, 0, ',', '.') }}</p>
                                    </div>
                                </div>
      
                                <p class="text-sm font-semibold text-gray-900">Rp {{ number_format($item->subtotal ?? 0, 0, ',', '.') }}</p>
                            </div>
                        @endforeach
                    </div>
