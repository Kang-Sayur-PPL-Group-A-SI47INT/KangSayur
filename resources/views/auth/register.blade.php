        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 bg-white">
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Confirm Password</label>
                        <div class="relative">
                    ...
                    <!-- Submit -->
                    <button type="submit" class="btn-primary-green flex items-center justify-center gap-2">
                        Join the Community
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg>
                    </button>
                </form>
                ...
                <p class="text-center text-sm text-gray-500 mt-8">
                    Already part of the harvest? <a href="{{ route('login') }}" class="text-green-700 hover:text-green-800 font-semibold">Log In</a>
                </p>
            </div>
        </div>
    </div>
